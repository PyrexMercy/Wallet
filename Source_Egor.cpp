					...
					else
					{
						...
						else
						{
							...
							if (amount >= total_value)
							{
								...
								Transaction::Transaction_for_Stock(2, total_value, comment);
			...
			if (selected_index == index)
			{
				...
				else
				{
					...
					else
					{
						...
						double total_value_1 = stol(shares) * avg_share_price;
						double total_value_2 = tradable_shares * tradable_share_price+profit;
						comment = company_name + "; Shares: " + to_string(tradable_shares) + "; Share Price:" + to_string(tradable_share_price);
						Transaction::Transaction_for_Stock(1, total_value_2, comment);
